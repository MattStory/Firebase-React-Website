...
class pastChart extends React.Component {
    ...
    if(amount != undefined) {
      ...
      var date_format  = month[dt[0]] + " " + dt[1]+ ", " + dt[2];
        ...
        if (!myMap.get(amount[i].transactionCategory).value) {
          chartDataPie1[i] = {label: amount[i].transactionCategory, value: amount[i].amount };
  ...
  //          console.log ("Before ", parseInt(chartDataPie[myMap.get(amount[i].merchant).index].value) + parseInt(amount[i].amount));
            chartDataPie1[myMap.get(amount[i].transactionCategory).index] = {label: amount[i].transactionCategory, value: (parseInt(chartDataPie1[myMap.get(amount[i].transactionCategory).index].value) + parseInt(amount[i].amount))};
        }
      }
        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
const chartConfigsLineM1 = {
  ...
  dataSource: {
    ...
    if(amount != undefined) {
      ...
      for (let i = 0; i < amount.length; i++) {
        myMap2.set(amount[i].transactionCategory, { index: 0 , value: false});
      }
      ...
      var date_format  = month[dt[0]] + " " + dt[1]+ ", " + dt[2];
        ...
        if (!myMap2.get(amount[i].transactionCategory).value) {
          
          chartDataPie[i] = {label: amount[i].transactionCategory, value: amount[i].amount };
        } else {
  //          console.log ("Before ", parseInt(chartDataPie[myMap.get(amount[i].merchant).index].value) + parseInt(amount[i].amount));
            chartDataPie[myMap2.get(amount[i].transactionCategory).index] = {label: amount[i].transactionCategory, value: (parseInt(chartDataPie[myMap.get(amount[i].transactionCategory).index].value) + parseInt(amount[i].amount))};
        }
      //}


        myMap2.set(amount[i].transactionCategory, {index :i, value : true});
        //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
